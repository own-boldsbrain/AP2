# Script para inicif (-not (Test-CommandExists "python" "Python não encontrado. Por favor, instale o Python 3.10 ou superior.")) {
    $errorCount++
}
...
if (-not (Test-CommandExists "docker" "Docker não encontrado. É recomendado instalar o Docker para os serviços dependentes.")) { ambiente de desenvolvimento no Windows
